...
public:
    ...
    void make_step(
        ...
        const std::array<double, RHS::N> &a_y,
        ...
        while (flag) {
            ...
            // k1
            m_rhs->differentiate(a_t, a_y, rhs_result);
            ...
            m_rhs->differentiate(a_t + 1.0 / 4.0 * a_h, y_for_k2, rhs_result);
            ...
            m_rhs->differentiate(a_t + 3.0 / 8.0 * a_h, y_for_k3, rhs_result);
            ...
            for (int i = 0; i < RHS::N; i++) {
                y_for_k4[i] = a_y[i] + k4_consts[0] * k1[i] + k4_consts[1] * k2[i] +
                              k4_consts[2] * k3[i];
            }
            m_rhs->differentiate(a_t + 12.0 / 13.0 * a_h, y_for_k4, rhs_result);
            ...
            for (int i = 0; i < RHS::N; i++) {
                y_for_k5[i] = a_y[i] + k5_consts[0] * k1[i] + k5_consts[1] * k2[i] +
                              k5_consts[2] * k3[i] + k5_consts[3] * k4[i];
            }
            m_rhs->differentiate(a_t + a_h, y_for_k5, rhs_result);
            ...
            for (int i = 0; i < RHS::N; i++) {
                y_for_k6[i] = a_y[i] + k6_consts[0] * k1[i] + k6_consts[1] * k2[i] +
                              k6_consts[2] * k3[i] + k6_consts[3] * k4[i] +
                              k6_consts[4] * k5[i];
            }
            m_rhs->differentiate(a_t + 1. / 2. * a_h, y_for_k6, rhs_result);
            std::array<double, RHS::N> k6 = {};
            for (int i = 0; i < RHS::N; i++) {
                k6[i] = a_h * rhs_result[i];
            }
            // delta
            std::array<double, RHS::N> delta = {};
            for (int i = 0; i < delta.size(); i++) {
                delta[i] = delta_consts[0] * k1[i] + delta_consts[1] * k2[i] +
                           delta_consts[2] * k3[i] + delta_consts[3] * k4[i] +
                           delta_consts[4] * k5[i] + delta_consts[5] * k6[i];
            }
            double delta_norm = 0;
            for (int i = 0; i < delta.size(); i++) {
            ...
            if (delta_norm > eps) {
                ...
                for (int i = 0; i < RHS::N; i++) {
                    a_y_next[i] = a_y[i] + gamma_consts[0] * k1[i] +
                                  gamma_consts[1] * k2[i] + gamma_consts[2] * k3[i] +
                                  gamma_consts[3] * k4[i] + gamma_consts[4] * k5[i] +
                                  gamma_consts[5] * k6[i];
                }
                flag = false;
            }
